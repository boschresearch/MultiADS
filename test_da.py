...
import open_clip
from domain_adaption import memory
...
if __name__ == '__main__':
    ...
    parser.add_argument("--mode", type=str, default="domain_adaption", help="zero shot or few shot")
    parser.add_argument("--seed", type=int, default=42, help="random seed")
    parser.add_argument("--quantile", type=float, default=0.001, help="percent of the qunatile of nearest neighbour")
