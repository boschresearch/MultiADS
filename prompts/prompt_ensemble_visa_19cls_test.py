...
def encode_text_with_prompt_ensemble(model, objs, tokenizer, device):
    ...
    prompt_state = [normal, damage, scratch, breakage, burnt, weird_wick, stuck, crack, wrong_place, partical, bubble, melded, hole, melt, bent, spot, extra, chip, missing, discolor, leak]
