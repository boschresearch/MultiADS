...
def encode_text_with_prompt_ensemble(model, objs, tokenizer, device):
    ...
    pit = [
        '{} has a pit defect',  
        'Small cavities or pits detected on {}',  
        '{} shows surface pitting due to wear',  
        'Localized corrosion pits found on {}',  
        '{} has small indentations affecting the surface',  
        'Surface of {} appears rough with pit-like imperfections'  
    ]
    ...
    deformation = [
        ...
        '{} appears twisted or misshaped',  
        'Structural distortion detected on {}',  
        'Unexpected shape deformation found in {}',  
        '{} shows signs of bending under stress'  
    ]

    abrasion = [
        '{} has an abrasion defect', '{} has noticeable scratches or scuffing', 'Surface of {} is affected by continuous rubbing', 'Worn or scraped areas found on {}' 
    ]
    ...
    foreing = [
        '{} has foreign objects defect', '{} has a foreign defect', 'Unexpected foreign material on {}', 
        '{} contains an unwanted foreign object', 
